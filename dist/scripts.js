...
const getPaymentLink = () => {
  const fields = JSON.parse(localStorage.getItem('selected-product'));
  ...
  validate
    ...
    .onSuccess((event) => {
      ...
      if(nextStep=='mercado-pago')
        ...
        document.location.href= 'https://wa.me/5491121685045?text=Me%20interesa%20pagar%20en%20Ethereum';
      }else{
      goToUrl(nextStep, '/checkout');
      }
        //
